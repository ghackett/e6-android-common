 ...
 * tutorial</a>.</p>
 */
public class EzTabHost extends RelativeLayout implements ViewTreeObserver.OnTouchModeChangeListener {

    private EzTabWidget mTabWidget;
    private FrameLayout mTabContent;
    private EzTabActivity mTabActivity;
    ...
    public EzTabHost(Context context) {
        super(context);
        initEzTabHost();
    }

    public EzTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
        initEzTabHost();
    }

    private void initEzTabHost() {
...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
      */
    private void setup() {
        mTabWidget = (EzTabWidget) findViewById(mTabActivity.getTabWidgetViewId());
        if (mTabWidget == null) {
            throw new RuntimeException(
                    "Your TabHost must have a TabWidget");
        }
        ...
        mTabWidget.setTabSelectionListener(new EzTabWidget.OnTabSelectionChanged() {
        ...
        mTabContent = (FrameLayout) findViewById(mTabActivity.getTabContentViewId());
        if (mTabContent == null) {
            throw new RuntimeException(
                    "Your TabHost must have a FrameLayout ");
        }
    }
...
//        }
        ...
        /**
         * Specify a view id in tabwidget as an indicator
         */
        public TabSpec setIndicator(int viewResId) {
        	mIndicatorStrategy = new ViewIdIndicatorStrategy(viewResId);
        	return this;
        }
...
//            View tabIndicator = inflater.inflate(android.R.layout.tab_indicator,
...
//    }
    ...
    /**
     * How to create a tab indicator by specifying a view id in the tabWidget
     */
    private class ViewIdIndicatorStrategy implements IndicatorStrategy {
    	
    	private final View mView;
    	
        private ViewIdIndicatorStrategy(int viewResId) {
            mView = getTabWidget().findViewById(viewResId);
        }
